                                    ...
                                    <form action="" method="POST">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <!-- Input Item -->
                                                <div class="mb-1 row">
                                                    <label for="name" class="col-sm-12 col-form-label">Nama Gudang</label>
                                                    <div class="col-sm-12">
                                            ...
                                            <div class="col-md-4">
                                                <!-- Input Item -->
                                                <div class="mb-1 row">
                                                    <label for="code" class="col-sm-12 col-form-label">Code Gudang</label>
                                                    <div class="col-sm-12">
                            ...
                            <div class="container shadow px-4 py-4">
                                ...
                                <div class="table-responsive-lg">                                
                                    <table id="show_table" class="table-sm display nowrap table-hover">
                                        ...
                                        <tbody>
                                            <?php
                                            $sql2   = "SELECT * FROM $tabelnya where idgud!='0' ORDER BY create_at DESC";
                                            ...
                                            ?>
                                                <tr>
                                                    <td scope="row">
                                                        <a href="add-gudang.php?op=edit&id=<?php echo $id ?>"><button type="button" class="btn btn-sm btn-warning">Edit</button></a>
                                                        <a href="add-gudang.php?op=delete&id=<?php echo $id?>" onclick="return confirm('Are you sure you want to delete the data?')"><button type="button" class="btn btn-sm btn-danger">Delete</button></a>            
                                                    </td>
